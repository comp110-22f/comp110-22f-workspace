...
if counter_man == 1: print(str(counter_man) + " instance of " + letter + " found in " + greeting) 
if counter_man >1: print(str(counter_man) + " instances of " + letter + " found in " + greeting) 
if counter_man == 0: print("No instances of " + letter  + " found in " +  greeting)
